from file_api.adapters.embeddings.openai_embeddings import OpenAIEmbeddingsClient, OpenAIEmbeddingModel
...
def get_embeddings_service() -> EmbeddingsService:
    return EmbeddingsService(OpenAIEmbeddingsClient(OpenAIEmbeddingModel.ADA_002))
