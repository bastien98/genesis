...
class VectorDbService:
    ...
    async def save_chunks_to_kb(self, chunks: list[str], username: str, kb_id: int, doc_name: str) -> None:
        await self.vectordb_adapter.save_chunks(chunks, username, kb_id, doc_name)
