...
try:
    ...
    adapter.add_pdf_document_for_user_and_kb(1, 1, Document(
        username="bastien", kb_name="kb-1", doc_name="test", source="NA", document_manager=DocumentManager(), content=bytes()
    ))
