...
from file_api_v2.domain.entities.knowledge_base import DocumentAlreadyExistsError
from file_api_v2.domain.entities.raw_document import RawDocument
from file_api_v2.domain.entities.user import KnowledgeBaseNotFoundError
...
class KnowledgeBaseService:
    ...
    async def add_document(self, raw_doc: RawDocument, username: str, kb_name: str) -> None:
        ...
        # Add document to knowledge base in domain
